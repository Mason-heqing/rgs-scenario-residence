    ...
    methods: {
        ...
        */
        ...
        changeTime(e){
            ...
            //     this.dataForm.statDateStart = e[0].replace(/-/g,"");
            //     this.dataForm.statDateEnd = e[1].replace(/-/g,"");
            // }else{
        ...
        //     // console.log(e)
        //     if (this.timers !== null && this.timers.length > 0) {
        //         this.dataForm.statDateStart = this.timers[0].replace('-','');
        //         this.dataForm.statDateEnd = this.timers[1].replace('-','');
        //       } else {
