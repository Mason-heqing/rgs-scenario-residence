              ...
              <div class="box-body" v-loading="loading">
                    ...
                    <el-table-column slot="operate1" label="抓拍照片" align="center" width="120">
                        <template slot-scope="scope">
                          <img @click="seeContent(scope.row)" v-if="scope.row.snapPic !=''" style="cursor: pointer;width:80px;height:80px;display: inline-block;" :src="imgurl+'/file/download?path='+scope.row.snapPic" alt />
                        </template>
                    </el-table-column>
                    <el-table-column slot="operate1" label="对比照片" align="center" width="120">
                        <template slot-scope="scope">
                          <img @click="seeContent(scope.row)" v-if="scope.row.comparePic !=''"  style="cursor: pointer;width:80px;height:80px;display: inline-block;" :src="imgurl+'/file/download?path='+scope.row.comparePic" alt />
                        </template>
                    </el-table-column>
                    </table-cmp>
