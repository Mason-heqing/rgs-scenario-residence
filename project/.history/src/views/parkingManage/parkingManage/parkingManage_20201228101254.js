...
export default {
  ...
  methods: {
    ...
    //配置支付
    setPayment(data){
      // this.setPaymentForm.paymentMode = "";
      // this.setPaymentForm.payStatus = "";
      // this.setPaymentForm.paydataTime = "";
      // this.setPaymentForm.id = "";
      // this.setPaymentForm.payChannel = "";
    ...
    //配置支付方式
    setPayMode(fromMsg){
      // console.log("提交设置支付方式信息---》",this.setPaymentForm);
