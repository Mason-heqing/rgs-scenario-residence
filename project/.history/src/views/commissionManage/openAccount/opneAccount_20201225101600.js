...
export default {
  ...
  //动态校验开户返佣配置
    ...
    //     this.rules[`monthDayNum${index}`] = [{
    //       required: true, message: '请输入人员', trigger: 'blur'
    //     }]
    //   })
    //   // this.rules = JSON.parse(JSON.stringify(this.rules)) // 转成响应式数据
    //   console.log("动态校验表单--------->",this.rules);
    // },

  
    //返佣设置
    goSet(data){
      console.log("获取返佣设置有效值--->",data);
      // this.setCommission = data;
      // this.setCommission.paydataTime[0] = data.startDate.slice(0,10);
      // this.setCommission.paydataTime[1] = data.endDate.slice(0,10);
      // this.setCommission.paydataTime = ['2020-12-08','2020-12-09'];
      // console.log('什么鬼---->',data.startDate.slice(0,10));
      // let end = new Date();
      // let start = new Date();
