...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '车场名称', param: 'name', align: 'left', sortable: true, isshow: true,width:'110'},
        { label: '车场编号', param: 'id', align: 'left', sortable: true, isshow: true,width: '270' },
        { label: '地区', param: 'region', align: 'left', sortable: true, isshow: true,width:'110'},
        { label: '车场业态', param: 'parkType', align: 'left', sortable: true, isshow: true,width:'110',render: (row) => {
          if ( 0 === row.parkType ) {
             return  '住宅' 
        ...
        { label: '线上支付', param: 'payStatus', align: 'left', sortable: true, isshow: true,width:'110',render(h) {
          if(0 === h.payStatus){
            return '待开通'
        ...
        { label: '断开时间', param: 'offTime', align: 'left', sortable: true, isshow: true,width:'160'},
        { label: '恢复时间', param: 'connectionTime', align: 'left', sortable: true, isshow: true,width:'160'},
        { label: '当前状态', param: 'onlineStatus', align: 'left', sortable: true, isshow: true,width:'110',render(h) {
          if(1 == h.onlineStatus){
            return '已连接'
          }else{
            return '已断开'
