  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '未收金额元', param: 'uncollectedAmt', align: 'left', sortable: true, isshow: true,width:'130'},
        { label: '折扣金额(元)', param: 'discountAmt', align: 'left', sortable: true, isshow: true,width:'130'},
        { label: '支付时间', param: 'payTime', align: 'left', sortable: true, isshow: true,width:'180'},
