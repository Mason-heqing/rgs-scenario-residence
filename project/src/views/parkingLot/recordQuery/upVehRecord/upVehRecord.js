...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '车牌号码', param: 'name', align: 'left', sortable: true, isshow: true},
        { label: '入场识别车牌', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '出场识别车牌', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '车类', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '车型', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '进通道', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '出通道', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '进场时间', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '出场时间', param: 'region', align: 'left', sortable: true, isshow: true},
