  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <i class="glyphicon glyphicon-adjust"></i> 临时车缴费
        </li>
      </ol>
    </section>
                  ...
                  <div class="col-lg-2 pl-0">
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        style="width: 100%"
                        placeholder="输入值班人姓名"
                        v-model="dataForm.outDutyPersonName"
                      ></el-input>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-2">
                    <div class="form-group">
                      <div class="col-md-12">
                        <el-select
                          clearable=""
                          v-model="dataForm.inWorkstationName"
                          placeholder="岗亭名称"
                        >
                          <el-option
                            v-for="item in inWorkstationList"
                            :key="item.id"
                            :label="item.name"
                            :value="item.vgsId"
                          ></el-option>
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <div class="col-md-12">
                        <el-select
                          clearable=""
                          v-model="dataForm.releaseType"
                          placeholder="放行类型"
                        >
                          <el-option
                            v-for="item in outEntryTypeList"
                            :key="item.id"
                            :label="item.name"
                            :value="item.id"
                          ></el-option>
                  ...
                  <div class="col-lg-2">
                    <div class="form-group">
                      <div class="col-md-12">
                        <el-select
                          clearable=""
                          v-model="dataForm.parkTime"
                          placeholder="停车时长"
                        >
                          <el-option
                            v-for="item in stayMinutesList"
                            :key="item.id"
                            :label="item.name"
                            :value="item.id"
                          ></el-option>
...
<script src="./tempCarPay.js"></script>
<style scoped lang="scss">
@import "./tempCarPay.scss";
</style>
