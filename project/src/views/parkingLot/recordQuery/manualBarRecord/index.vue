  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <i class="glyphicon glyphicon-adjust"></i> 手动抬杆记录
        </li>
      </ol>
    </section>
                  ...
                  <div class="col-lg-3 pl-0">
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        style="width: 100%"
                        placeholder="输入值班人姓名"
                        v-model="dataForm.outOperatorName"
                      ></el-input>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-3 pl-0">
                    <div class="form-group">
                      <div class="col-md-12">
                        <el-select
                          clearable=""
                          v-model="dataForm.openGateType"
                          placeholder="开闸类型"
                        >
                          <el-option
                            v-for="item in openGateTypeList"
                            :key="item.id"
                            :label="item.name"
                            :value="item.id"
                          ></el-option>
...
<script src="./manualBarRecord.js"></script>
<style scoped lang="scss">
@import "./manualBarRecord.scss";
</style>
