  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">
          <i class="glyphicon glyphicon-adjust"></i> 进出记录
        </li>
      </ol>
    </section>
...
<script src="./inOrOutRecord.js"></script>
<style scoped lang="scss">
@import "./inOrOutRecord.scss";
.box-body /deep/ .el-table .cell {
  white-space: nowrap;
}
</style>
