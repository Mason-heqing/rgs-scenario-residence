  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '续费月数', param: 'chargeMonthCount', align: 'left', sortable: true, isshow: true,width:'110'},
        ...
        { label: '原有效期', param: 'oldExpireDate', align: 'left', sortable: true, isshow: true,width:'180'},
        { label: '新有效期', param: 'newExpireDate', align: 'left', sortable: true, isshow: true,width:'180'},
        { label: '续费时间', param: 'payTime', align: 'left', sortable: true, isshow: true,width:'180'},
