...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '车位组名称', param: 'name', align: 'left', sortable: true, isshow: true},
        { label: '车位数量', param: 'placeCount', align: 'left', sortable: true, isshow: true},
        // { label: '备注', param: 'region', align: 'left', sortable: true, isshow: true},
