...
export default {
  ...
  data() {
    ...
    return {
      ...
      tableLabel: [
        { label: '子渠道名称', param: 'orgName', align: 'left', sortable: true, isshow: true },
        {
          label: '单个车场返佣(元)', param: 'rewardPark', align: 'left', sortable: true, isshow: true,width:'60', render(h) {
            if (0 != h.rewardPark) {
        ...
        { label: '有效时间', param: 'tempTime', align: 'center', sortable: true, isshow: true, width: '80' },
        {
          label: '状态', param: 'enabled', align: 'center', isshow: true, sortable: true, width: '40', render(h) {
            if (1 === h.enabled) {
              return '启用'
            } else {
              return '停用'
      ...
      tableLabel1: [
        { label: '车场名称', param: 'parkName', align: 'left', sortable: true, isshow: true },
        { label: '所属渠道', param: 'organizationName', align: 'left', sortable: true, isshow: true },
        { label: '地区', param: 'area', align: 'left', sortable: true, isshow: true, width: '100' },
        {
          label: '车场业态', param: 'parkType', align: 'left', isshow: true, sortable: true, width: '120', render(h) {
            if (0 === h.parkType) {
              return '住宅'
        ...
        { slot: 'operate', isshow: true ,align: 'center'}, // 操作列
      ],
      tableOption: [],
      tableSelect: [],
      activeName: 'first',
      ...
      tableLabel2: [
        ...
        { label: '子渠道名称', param: 'organizationName', align: 'left', sortable: true, isshow: true },
        { label: '考核通过总数', param: 'reachNum', align: 'left', isshow: true, sortable: true },
        {
          label: '返佣总金额（元）', param: 'rewardAmount', align: 'left', isshow: true, sortable: true, render(h) {
            if (0 != h.rewardAmount) {
  ...
  methods: {
   ...
   getLastMonthAndDay() {
    ...
    this.PersonListForm2.reconTime = year.toString() + month.toString();
    },
    ...
    //物料返佣对账查询
    querySearch2(){
      this.PersonListForm2.currentPage = 1;
      this.getLeftData();
    },
    ...
    againApply(row){
      ...
      this.popRewardApply = true;
      this.utils.http({
        url: "/manage/material/apply/getMaterilById?id=" + row.id,
        method: "get",
    ...
    sendExport(){
      // console.log(this.PersonListForm2);
      this.utils.http({
        url: '/manage/export/reward/exportMaterialInfo',
        method: "get",
        params:this.PersonListForm2
      },
      res => {
