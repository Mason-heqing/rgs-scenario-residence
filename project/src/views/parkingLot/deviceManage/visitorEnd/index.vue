            ...
            <div class="box box-primary">
              <div class="box-body">
                <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
                      ...
                      <el-table-column prop="name" align="center" label="操作" width="150">
                        <template slot-scope="scope">
                          <el-row>
                            ...
                            <el-button type="primary" icon="el-icon-edit" round @click="clickEdit(scope.row.id)" size="mini">设置</el-button>
                  ...
                  <el-tab-pane label="假日通行规则" name="second">假日通行规则</el-tab-pane>
...
<script src="./visitorEnd.js"></script>
<style scoped lang="scss">
@import "./visitorEnd.scss";
</style>
