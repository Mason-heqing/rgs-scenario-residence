...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '订单号', param: 'name', align: 'left', sortable: true, isshow: true},
        { label: '停车场', param: 'id', align: 'left', sortable: true, isshow: true},
        { label: '车牌号码', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '业务类型', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '支付方式', param: 'region', align: 'left', sortable: true, isshow: true},
        // { label: '支付状态', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '支付金额', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '支付时间', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '支付流水号', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '停车记录ID', param: 'region', align: 'left', sortable: true, isshow: true},
