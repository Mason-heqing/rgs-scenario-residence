  ...
  <div class="content-wrapper">
     <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">
            <i class="glyphicon glyphicon-adjust"></i> 处理报修
          </li>
        </ol>
      </section>
         ...
         <div class="box box-primary">
              <div class="repairs-box">
                ...
                <div class="repairs-msg">
                  <p>报修人：{{dataForm.personName}}</p>
                  <p>手机号码：{{dataForm.phone}}</p>
                  <p>房屋信息：{{dataForm.houseAddress}}</p>
                  <h4 class="mt-30">{{dataForm.resRepair}}</h4>
                  <div class="mt-20">{{dataForm.resDesc}}</div>
                  <div class="img-box mt-20">
                    <el-image 
                      v-for="(item,index) in dataForm.repairImage" :key="index"
                    ...
                    <!-- <img v-for="(item,index) in dataForm.repairImage" :key="index" style="width:80px;height:80px" :src="imgurl+'/file/download?path='+item" alt /> -->
                  </div>
                  <el-form
                    :model="repairsForm"
                    :rules="rules"
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-12">
                        <el-form-item prop="dealSuggestion">
                          <el-input maxlength="100" show-word-limit type="textarea" v-model="repairsForm.dealSuggestion"></el-input>
                        </el-form-item>
                      </div>
                    </div>
                  </el-form>
                    <div class="form-group text-center pb-40">
                        <button class="btn btn-primary mr-20" v-if="!isRequst" @click="addRepairs('repairsForm')">保存</button>
