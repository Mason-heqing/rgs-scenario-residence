  ...
  <div class="content-wrapper">
     <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">
            <i class="glyphicon glyphicon-adjust"></i> 房屋报修
          </li>
        </ol>
      </section>
              ...
              <div class="box-body" v-loading="loading">
                    <div class="form-horizontal">
                      <div class="col-lg-2 pl-0">
                        <div class="form-group">
                          <div class="col-md-12">
                            <el-input clearable style="width:100%" placeholder="搜索标题" v-model="dataForm.resRepair"></el-input>
                          </div>
                        </div>
                      </div>
                      <div class="col-lg-2">
                    ...
                    <el-table-column slot="operate" label="操作" align="center" width="120">
                        <template slot-scope="scope">
                            <el-row>
                              <el-button v-if="scope.row.dealStatus==0" title="处理" type="primary" icon="el-icon-edit" round  size="mini" @click="goRepair(scope.row)"></el-button>
                            </el-row>
                        </template>
                    </el-table-column>
                    </table-cmp>
...
<script src="./housingRepair.js"></script>
<style scoped lang="scss">
@import "./housingRepair.scss";
</style>
