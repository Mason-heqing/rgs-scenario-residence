              ...
              <div class="box-body" v-loading="loading">
                    ...
                    <el-table-column slot="operate" label="操作" align="center" width="200">
                        <template slot-scope="scope">
                           <el-row>
                              <el-button title="编辑" type="primary" icon="el-icon-edit" round  size="mini" @click="editContact(scope.row)"></el-button>
                              <el-button title="删除" type="danger" icon="el-icon-delete" round size="mini" @click="deleteContact(scope.row.id)"></el-button>
                            </el-row>
                        </template>
                    </el-table-column>
                    </table-cmp>
