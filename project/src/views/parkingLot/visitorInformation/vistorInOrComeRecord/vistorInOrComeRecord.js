...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '停车记录编号', param: 'name', align: 'left', sortable: true, isshow: true},
        { label: '访客姓名', param: 'id', align: 'left', sortable: true, isshow: true},
        { label: '车牌号码', param: 'region', align: 'left', sortable: true, isshow: true},
        { label: '手机号码', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '进场时间', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '出场时间', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '停车时长', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '应收', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '实收', param: 'parkType', align: 'left', sortable: true, isshow: true},
        { label: '折扣', param: 'parkType', align: 'left', sortable: true, isshow: true},
  ...
  methods: {
    ...
    resetBtn(){
        this.dataForm={
          ...
          payStatus :'',//支付方式
          organizationId:'',//所属渠道
          scenarioId:Cookies.get("scenarioId")//场景值
        }
        this.getListData();
      },
