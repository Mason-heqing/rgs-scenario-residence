...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [    
        { label: '对比照片', param: 'img', align: 'center', sortable: true ,isimg:true,isshow:true},
        ...
        { label: '人员类型', param: 'company', align: 'center',isshow:true },
        { label: '进出方向', param: 'email', align: 'center', width: '200',isshow:true },
        { label: '通行方式', param: 'email', align: 'center', width: '200',isshow:true },
        { label: '设备', param: 'email', align: 'center', width: '200',isshow:true },
