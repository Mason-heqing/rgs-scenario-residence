...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '订单号', param: 'id', align: 'center', sortable: true, isshow: false, width: '100' },
        { label: '商户号', param: 'mchId', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '支付渠道', param: 'payChannel', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '停车场', param: 'parkName', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '凭证(车牌)', param: 'voucherNo', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '金额(分)', param: 'totalAmount', align: 'center', isshow: false, sortable: true, width: '280' },
        { label: '应结算金额(分)', param: 'settlementAmount', align: 'center', sortable: true,isshow:true,width:'300'},
        { label: '入场时间', param: 'inParkTime', align: 'center', sortable: true,isshow:true,width:'120'},
        { label: '支付类型', param: 'payType', align: 'center', sortable: true,isshow:true,width:'130'},
        { label: '支付状态', param: 'payStatus', align: 'center', sortable: true,isshow:true,width:'130'},
        { label: '支付方式', param: 'payMethod', align: 'center', sortable: true,isshow:true,width:'130'},
