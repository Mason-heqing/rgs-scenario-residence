...
export default {
    ...
    data() {
        return {
            ...
            tableLabel: [
                { label: '停车场', param: 'parkName', align: 'left', sortable: false, isshow: true},
                { label: '地区', param: 'address', align: 'left', sortable: false, isshow: true},
                { label: '车场业态', param: 'parkType', align: 'left', sortable: false, isshow: true,render(row) {
                    if ( 0 === row.parkType ) {
                        return  '住宅' 
                ...
                { label: '支付总金额（元）', param: 'totalAccout', align: 'left', sortable: false, isshow: true,render(h) {
                    return h.totalAccout/100
                },},
                { label: '支付总笔数', param: 'tradeNum', align: 'left', isshow: true, sortable: false},
                { label: '日均笔数', param: 'avgTradeNum', align: 'left', sortable: false, isshow: true },
    ...
    methods: {
        ...
        */
        ...
        frequencySolt() {
            ...
            this.dataForm.orderField = 'avgTradeNum';
            this.getTableData();
        },
        //重置
        resetBtn() {
