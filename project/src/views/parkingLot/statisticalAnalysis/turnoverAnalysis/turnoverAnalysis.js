...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        ...
        { label: '停车次数', param: 'stopNums', align: 'left', sortable: true, isshow: true},
        { label: '车位数', param: 'parkGroupNums', align: 'left', sortable: true, isshow: true},
        { label: '周转率', param: 'rateProp', align: 'left', sortable: true, isshow: true},
  ...
  methods: {
    ...
    getListData() {
      this.utils.http({
        url: "/manage/park/analy/getEveryTurnRate",
        method: "post",
        data: this.dataForm
      },
        res => {
          if (res.code == 200) {
            ...
            if(res.data && 0 < res.data.length){
                ...
                $.each(res.data,(index,item)=>{
                  ...
                  this.queryDaysValue.push(item.rateProp);
                })
