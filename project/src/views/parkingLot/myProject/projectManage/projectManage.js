...
export default {
  ...
  data() {
    return {
      ...
      tableLabel: [
        { label: '名称', param: 'name', align: 'center', sortable: true, isshow: true, width: '100' },
        { label: '所在省份', param: 'province', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '所在城市', param: 'city', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '所在区', param: 'area', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: '详细地址', param: 'address', align: 'center', sortable: true, isshow: true, width: '120' },
        { label: 'ID', param: 'id', align: 'center', isshow: false, sortable: true, width: '280' },
        // { label: '秘钥', param: 'appSecret', align: 'center', sortable: true,isshow:false,width:'300'},
        // { label: '回调地址', param: 'callbackUrl', align: 'center', sortable: true,isshow:true,width:'120'},
  ...
  created() {
    if (process.env.NODE_ENV == 'development') {
      this.isdevelopment = '/api' + '/app/user/qrCodeDownload?id=';
    } else {
      this.isdevelopment = process.env.API_HOST + '/app/user/qrCodeDownload?id=';//接口域名和网站域名不一致时
    }
    this.isName = "&name=";
  ...
  methods: {
    ...
    downErcode(e) {
      ...
      // }
      // x.send();
      // window.location =  "/app/user/qrCodeDownload?id=" + e.id + "&name=" + e.name

      // this.utils.http({
      //   url: "/app/user/qrCodeDownload",
      //   method: "GET",
