export const mixin = {
    data() {
      ...
      options9:[        //设备类型
        ...
        positionList:[      //监控坐标点
          { lng: 113.944198, lat: 22.528774 },
          { lng: 113.945613, lat: 22.53064 },
          { lng: 113.94536355139878, lat: 22.529712896166103 }
        ],	
			showType:[
				{id:1,title:'单屏'},
				{id:4,title:'四屏'},
            ...
            this.vcrTiemE = dateStr+'T'+ hms
				...
				getUserCarInfo() {
					this.utils.http({
						...
						res => {
							if(res.code == 200) {
								this.carParkStatus = res.data.status
							}
							console.log(this.carParkStatus,'是否关联停车场!!')
						}
					)
				},
				  // 获取车类
				...
				selectUserpermis() {
					this.utils.http({
						...
						res => {
							if(res.code == 200) {
								this.aisleJurisdiction = res.data
							}
