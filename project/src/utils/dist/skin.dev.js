...
var _default = {
  changeSkin: function changeSkin() {
    (function ($, AdminLTE) {
      ...
      var my_skins = ["skin-black", "skin-blue", "skin-red", "skin-yellow", "skin-purple", "skin-green", "skin-blue-light", "skin-black-light", "skin-red-light", "skin-yellow-light", "skin-purple-light", "skin-green-light"]; //Create the new tab
      ...
      var tab_button = $("<li />").html("<a href='#control-sidebar-theme-demo-options-tab' data-toggle='tab'>" + "<i class='fa fa-wrench'></i>" + "</a>"); //Add the tab button to the right sidebar tabs

      $("[href='#control-sidebar-home-tab']").parent().after(tab_button); //Create the menu
      ...
      function change_skin(cls) {
        ...
        if ("skin-black-light" == cls || "skin-black" == cls) {
          $(".dropdown .select2-container--default .select2-selection--single .select2-selection__rendered").css("color", "#333");
          $(".dropdown .select2-container--default .select2-selection--single .select2-selection__arrow b ").css("border-color", "#333 transparent transparent transparent");
        } else {
          $(".dropdown .select2-container--default .select2-selection--single .select2-selection__rendered").css("color", "#fff");
          $(".dropdown .select2-container--default .select2-selection--single .select2-selection__arrow b ").css("border-color", "#fff transparent transparent transparent");
        }
      ...
      function setup() {
        ...
        $("[data-skin]").on("click", function (e) {
          ...
          e.preventDefault();
          change_skin($(this).data("skin")); // var classes = "hold-transition sidebar-mini" + " " + $(this).data('skin');
    ...
    })(_jqueryVender["default"], _jqueryVender["default"].AdminLTE);
  }
};
